...
export const dict = {
  ru: {
    ...
    // ── Hero ───────────────────────────────────────────────────
    "hero.eyebrow": "Теперь открыты в Бишкеке",
    ...
    // ── Footer ─────────────────────────────────────────────────
    "footer.tagline":
      "Современный ресторан в Бишкеке — вкусы степи, поданные с точностью.",
    "footer.navigation": "Навигация",
    "footer.contacts": "Контакты",
    "footer.hours": "Часы работы",
    "footer.hours.mon_thu": "Пн–Чт · 11:00 – 23:00",
    "footer.hours.fri_sun": "Пт–Вс · 11:00 – 01:00",
    ...
    "test.t1.quote":
      "Лучший бешбармак в Бишкеке. Атмосфера — будто оказался в юрте у деда.",
    ...
    "visit.address.body": "ул. Чуй, 142 · Бишкек",
    "visit.hours.title": "Часы работы",
    "visit.hours.body": "Ежедневно · 11:00 — 01:00",
    "visit.phone.title": "Телефон",
    "visit.phone.body": "+996 700 000 000",
  ...
  ky: {
    ...
    // ── Footer ─────────────────────────────────────────────────
    "footer.tagline":
      "Бишкектеги заманбап ресторан — талаанын даамдары, тактык менен сунушталат.",
    "footer.navigation": "Багыттоо",
    "footer.contacts": "Байланыш",
    "footer.hours": "Иш убактысы",
    "footer.hours.mon_thu": "Дш–Бш · 11:00 – 23:00",
    "footer.hours.fri_sun": "Жм–Жк · 11:00 – 01:00",
    ...
    "test.t1.quote":
      "Бишкектеги эң мыкты бешбармак. Атмосферасы — атамдын боз үйүндө отургандай.",
    ...
    "visit.address.body": "Чүй көч., 142 · Бишкек",
    "visit.hours.title": "Иш убактысы",
    "visit.hours.body": "Күн сайын · 11:00 — 01:00",
    "visit.phone.title": "Телефон",
    "visit.phone.body": "+996 700 000 000",
