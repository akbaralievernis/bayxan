...
export async function verifyPin(pin) {
  ...
  if (!supabase) {
    ...
    const mockStaff = [
      { id: 1, pin: "1234", name: "Байхан Асанов", role: "Шеф-повар" },
      { id: 2, pin: "5678", name: "Айгуль Сатарова", role: "Су-шеф" },
      { id: 3, pin: "9012", name: "Эльдар Бекбаев", role: "Старший администратор" },
    ];
