...
function Testimonial({ card }) {
  return (
    ...
    >
      ...
      <Quote
        size={24}
        className="absolute -top-2 left-5 text-amber-500/50 fill-amber-100/60"
        strokeWidth={1.2}
      />
      ...
      <figcaption className="flex items-center gap-3 pt-3 border-t border-stone-200/70">
        <div className="w-9 h-9 rounded-full bg-gradient-to-br from-amber-300 to-yellow-600 grid place-items-center text-white text-sm font-semibold shadow-gold-soft">
          {card.name.charAt(0)}
        </div>
